window.app = {
    /* 开发环境 */
    serverUrl: "http://localhost:8088", // 接口服务地址
    // paymentServerUrl: "http://192.168.1.3:8089", // 支付中心服务地址
    shopServerUrl: "http://localhost:8080/shop",   // 门户网站地址
    centerServerUrl: "http://localhost:8080/center",   // 用户中心地址
    cookieDomain: "",   // cookie域

    /* 测试环境 */
    // 跨域问题包括IP（域名）和端口
    // serverUrl: "http://api.openmall.sciatta.com", // 接口服务地址
    // // paymentServerUrl: "http://192.168.1.3:8089", // 支付中心服务地址
    // shopServerUrl: "http://shop.openmall.sciatta.com",   // 门户网站地址
    // centerServerUrl: "http://center.openmall.sciatta.com",   // 用户中心地址
    // cookieDomain: "openmall.sciatta.com",   // cookie域
        ...
        if (foodieShopcartCookie != null && foodieShopcartCookie != "" && foodieShopcartCookie != undefined) {
            ...
            for (var i = 0; i < foodieShopcart.length; i++) {
                ...
                if (specId == pendingItem.specId) {
                    ...
                    // 删除购物车中第i位置的1个元素，并添加tmpItem，即覆盖原商品
